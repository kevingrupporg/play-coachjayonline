        ...
        div(cls := "sections")(
          st.section(cls := "server")(
            ...
            p(
              ...
              "The more players and the higher it gets, but CJCA developers ",
              "do their best to keep it low. It rarely exceeds 10ms."
            )
          ),
          st.section(cls := "network")(
            h2("Network between CJCA and you"),
            div(cls := "meter"),
            p(
              "The time it takes to send a move from your computer to CJCA server, ",
              "and get the response back. ",
              "It's specific to your ",
              strong("distance to CJCA"),
              ", and ",
              "to the ",
              strong("quality of your Internet connection"),
              ". ",
              "CJCA developers can not fix your wifi or make light go faster."
            )
          )
        ),
        div(cls := "last-word")(
          ...
          h2("Lag compensation"),
          p(
            "CJCA compensates network lag. This includes sustained lag and occasional lag spikes. ",
