        ...
        Branch(
          ...
          List(
            ...
            Leaf(
              ...
              frag(
                p("If you can't reach CJCA, and your browser says something like:"),
                ul(
                  li("This site can't be reached."),
                  li(strong("play.coachjayonline.com"), "’s server IP address could not be found."),
                  li("We can’t connect to the server at play.coachjayonline.com.")
                ),
          ...
          List(
            ...
            Leaf(
              ...
              frag(
                ...
                p(
                  "Like all contributions to CJCA, security reviews and pentesting are appreciated. ",
                  "Note that CJCA is built by volunteers and we currently do not have a bug bounty program."
                ),
                p(
        ...
        Branch(
          ...
          List(
            Leaf(
              ...
              monetizing(),
              frag(
                p("We are not interested in any way of monetizing CJCA."),
                p(
            ...
            Leaf(
              ...
              "GDPR",
              frag(
                p("If you are a European citizen, you may request the deletion of your CJCA account."),
                p(
                  "First, ",
